...
public class Part1Tester {
    public static void main(String[] args) {
        ...
        list.add(3.0);
        list.add(8.0);
        System.out.println("\nTest contain method on object in CS2ArrayList");
        System.out.print(list.contains(3.0));
        System.out.println("\nTest contain method on object not in CS2ArrayList");
        System.out.print(list.contains(9.0));
        //test toArray
        System.out.println("\nTest toArray method on CS2ArrayList");
        System.out.print(list.toArray());
        //test clear
        System.out.println("\nTest clear method on CS2ArrayList");
        System.out.print(list.toArray());
        list.clear();
        System.out.print(list.toArray());
        list.add(10.0);
        ...
        list.add(8.0);
        //test equals
        System.out.println("\nTest contain method on filled CS2ArrayList");

        //test isEmpty
        System.out.println("\nTest isEmpty method on filled CS2ArrayList");
        System.out.print(list.isEmpty());
        System.out.println("\nTest isEmpty method on empty CS2ArrayList");
        list.clear();
        System.out.print(list.isEmpty());
